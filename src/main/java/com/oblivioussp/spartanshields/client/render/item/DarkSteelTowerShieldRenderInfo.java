...
public class DarkSteelTowerShieldRenderInfo extends TowerShieldRenderInfo 
{
	...
	protected static final RenderType LIGHTS_ON = RenderType.eyes(new ResourceLocation(ModSpartanShields.ID, "textures/entity/enderio/dark_steel_tower_shield_lights_on.png"));
	protected static final RenderType LIGHTS_OFF = RenderType.entityTranslucent(new ResourceLocation(ModSpartanShields.ID, "textures/entity/enderio/dark_steel_tower_shield_lights_off.png"));
	

	public DarkSteelTowerShieldRenderInfo(float rIn, float gIn, float bIn) 
	{
		super(new ResourceLocation(ModSpartanShields.ID, "entity/enderio/dark_steel_tower_shield_nopattern"),
				new ResourceLocation(ModSpartanShields.ID, "entity/enderio/dark_steel_tower_shield_pattern"));
		r = rIn;
		g = gIn;
		b = bIn;
	}
