...
public class ModItemModelProvider extends ItemModelProvider 
{
	...
	protected ResourceLocation createEnderIOPoweredBasicShieldModel(Item itemIn)
	{
		...
		ModelFile deactivatedModel = withExistingParent(itemPath + "_deactivated", new ResourceLocation(ModSpartanShields.ID, "basic_shield_base"))
				.texture("layer0", baseTexture).texture("layer1", deactivatedTexture);
		ModelFile deactivatedBlockingModel = withExistingParent(itemPath + "_deactivated_blocking", new ResourceLocation(ModSpartanShields.ID, "basic_shield_base_blocking"))
				.texture("layer0", baseTexture).texture("layer1", deactivatedTexture);
		ResourceLocation disabled = new ResourceLocation("disabled");
		ResourceLocation blocking = new ResourceLocation("blocking");
		return withExistingParent(itemPath, new ResourceLocation(ModSpartanShields.ID, "basic_shield_base"))
