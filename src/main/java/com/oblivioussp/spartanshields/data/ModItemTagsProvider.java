...
public class ModItemTagsProvider extends IntrinsicHolderTagsProvider<Item>
{
	...
	{
		super(output, ForgeRegistries.Keys.ITEMS, holderProvider, (item) ->
		{
			return ForgeRegistries.ITEMS.getDelegate(item).get().key();
	...
	protected void addTags(HolderLookup.Provider provider)
	{
		...
		tag(ModItemTags.TOWER_SHIELDS).add(ModItems.WOODEN_TOWER_SHIELD.get(), ModItems.STONE_TOWER_SHIELD.get(), ModItems.COPPER_TOWER_SHIELD.get() ,ModItems.IRON_TOWER_SHIELD.get(), ModItems.GOLDEN_TOWER_SHIELD.get(), ModItems.DIAMOND_TOWER_SHIELD.get(), ModItems.NETHERITE_TOWER_SHIELD.get(), ModItems.OBSIDIAN_TOWER_SHIELD.get(),
				...
				ModItems.BASIC_MEKANISTS_TOWER_SHIELD.get(), ModItems.ADVANCED_MEKANISTS_TOWER_SHIELD.get(), ModItems.ELITE_MEKANISTS_TOWER_SHIELD.get(), ModItems.ULTIMATE_MEKANISTS_TOWER_SHIELD.get(), ModItems.DARK_STEEL_RIOT_TOWER_SHIELD.get()).addOptional(new ResourceLocation("mekanismtools:bronze_shield")).addOptional(new ResourceLocation("mekanismtools:steel_shield")).
