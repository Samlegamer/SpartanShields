...
public class ConditionalShapedRecipeBuilder
{
	...
	public void save(Consumer<FinishedRecipe> consumerIn, ResourceLocation id)
	{
		...
		consumerIn.accept(new Result(serializer, id, result, count, group == null ? "" : group, pattern, keys, conditions, advancementBuilder, new ResourceLocation(id.getNamespace(), "recipes/" + id.getPath())));
	}
