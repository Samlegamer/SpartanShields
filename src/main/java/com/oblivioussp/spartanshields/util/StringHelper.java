...
public class StringHelper
{
	...
	{
		return getBlockUnlocalizedName(locName, Reference.ModID);
	}
	...
	{
		return translateFormattedString(unlocalizedStr, type, Reference.ModID, parameters);
	}
	...
	{
		return hasTranslateKey(key, type, Reference.ModID);
	}
	
	public static boolean hasTranslateKey(String key, String type, String modId)
	{
		if(type == null || type == "")
			return I18n.canTranslate(Reference.ModID.toLowerCase() + ":" + key);
